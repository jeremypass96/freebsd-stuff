...
echo "Welcome to the FreeBSD LXQT setup script."
echo "This script will setup Xorg, LXQT, some useful software for you, along with the rc.conf file being tweaked for desktop use."
echo ""
