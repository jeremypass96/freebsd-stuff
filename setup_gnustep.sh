...
echo "Welcome to the FreeBSD WindowMaker + GNUstep setup script."
echo "This script will setup Xorg, WindowMaker + GNUstep, some useful software for you, along with the rc.conf file being tweaked for desktop use."
echo ""
