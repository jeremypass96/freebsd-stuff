...
echo "Welcome to the FreeBSD GNOME setup script. This script will setup Xorg, GNOME, some useful software for you, along with system files being tweaked for desktop use."
